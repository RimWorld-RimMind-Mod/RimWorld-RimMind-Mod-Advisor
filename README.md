...
| **RimMind-Advisor** | **状态/Thought → 建议、审批、动作与反馈闭环** | Core（Actions 可选） | [链接](https://github.com/RimWorld-RimMind-Mod/RimWorld-RimMind-Mod-Advisor) |
...
| **RimMind-Advisor** | **Thought/Status → advice, player approval, action & feedback loop** | Core (Actions optional) | [Link](https://github.com/RimWorld-RimMind-Mod/RimWorld-RimMind-Mod-Advisor) |
